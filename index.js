...
document.getElementById("submit").onclick = function(){
    ...
    document.getElementById("CE-output-tree").textContent = `Number of Trees: ${Math.round(Tree_TCE)} to be planted.`;
    document.getElementById("CE-output-land").textContent = `Land area required: ${land_area.toFixed(3)} Acres.`;
}